  ...
  return (
    <Layout>
        ...
        <div className='blogDetail container mx-auto flex flex-row'> 
            ...
            <strong className="sectionTitleSm mb-5">Hiring SaaS execs is 'Horses for courses</strong>
            <div className='img'>
                <img src="https://assets-global.website-files.com/627210afa6fa44a4a391db98/62cb40de96459b1b6fad6dc7_1655696315179.png" alt="" />
            </div>
            <div className="desc">
