            ...
            <div className="flex w-full flex-row mb-0" data-testid="comment-component">
                ...
                <div className="grow">
                    <div className="-mt-[3px] mb-2 flex items-start">
                        <div>
                            <h4 className="text-[rgb(23,23,23] font-sans text-[17px] font-bold tracking-tight dark:text-[rgba(255,255,255,0.85)]">{name}</h4>
                    ...
                    <div className="mt mb-2 flex flex-row items-center gap-4 pr-4">
                        <p className="m-0 gh-comment-content font-sans text-[16px] leading-normal text-neutral-900 dark:text-[rgba(255,255,255,0.85)]" data-testid="comment-content"> {comment} </p>
                    </div>
                    <div className="flex items-center gap-5">
                        <button type="button" className="group duration-50 flex items-center font-sans text-sm outline-0 transition-all ease-linear text-[rgba(0,0,0,0.5)] dark:text-[rgba(255,255,255,0.5)] hover:text-[rgba(0,0,0,0.75)] hover:dark:text-[rgba(255,255,255,0.25)] cursor-pointer" data-testid="like-button">
                            <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg" stroke="black" className=" mr-[6px] stroke-[rgba(0,0,0,0.5)] dark:stroke-[rgba(255,255,255,0.5)] group-hover:stroke-[rgba(0,0,0,0.75)] dark:group-hover:stroke-[rgba(255,255,255,0.25)] transition duration-50 ease-linear">
